...
import { getStoredProducts } from '../services/storage.js';
    ...
    <div className="min-h-screen">
      <section className="relative h-[60vh] flex items-center justify-center bg-neutral-900 overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="serif text-5xl md:text-7xl font-bold mb-4">Aura Luxe</h1>
          <p className="text-xl md:text-2xl font-light tracking-widest uppercase mb-8">Crafting Timeless Elegance</p>
            ...
            <div key={product.id} className="group">
              <div className="relative aspect-[4/5] overflow-hidden bg-neutral-100 rounded-lg mb-4">
                ...
                <button 
                  ...
                  className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur text-neutral-900 py-3 font-semibold opacity-0 translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 hover:bg-neutral-900 hover:text-white flex items-center justify-center gap-2"
                >
              ...
              <p className="text-neutral-500 text-sm italic font-light line-clamp-2">{product.description}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <footer className="bg-neutral-50 py-20 border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-6 text-sm font-semibold tracking-widest uppercase text-neutral-400">
            ...
            <a href="#" className="hover:text-amber-600">Store</a>
            <a href="#" className="hover:text-amber-600">Heritage</a>
